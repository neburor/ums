        ...
        if($ads)
        {
          ...
          foreach ($ads as $key => $value) {
            ...
            echo '<li class="list-group-item">
                  <a href="'.ADURL.$value['id'].'.html" class="media">
                    <div class="media-left">
                      <span class="fa fa-edit fa-2x"></span>
                    </div>
                    <div class="media-body">
                      <span class="media-heading"><b>'.$value['title'].'</b><small class="pull-right">Hace '.$date[0].' '.$date[1].'</small></span>
                      <p><span class="fa fa-info-circle"></span> Pendiente de aprovación</p>
                    </div>
           ...
           <div class="form-group">
            ...
            <div class="input-group">
              ...
              if(isset($_SESSION['feedback'][$form['id']]['perro'])){
                echo FeedbackValue($_SESSION['feedback'][$form['id']]['perro'],$feedback);
              }
              ...
              if(isset($_SESSION['feedback'][$form['id']]['edad'])){
                echo FeedbackValue($_SESSION['feedback'][$form['id']]['edad'],$feedback);
              }
              echo ' required="requiered">
              <span class="input-group-btn hidden-xxs" style="width:0px;"></span>
              <input type="text" class="form-control" name="color" placeholder="Color"';
              if(isset($_SESSION['feedback'][$form['id']]['color'])){
                echo FeedbackValue($_SESSION['feedback'][$form['id']]['color'],$feedback);
              }
              echo ' required="requiered">
              <span class="input-group-btn hidden-xxs" style="width:0px;"></span>
              <select class="form-control" name="sexo" required="requiered">';
              if(isset($_SESSION['feedback'][$form['id']]['sexo'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['sexo'],$feedback);
              }
          echo '
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              if(isset($_SESSION['feedback'][$form['id']]['esterilizado'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['esterilizado'],$feedback);
              }
          echo '
              ...
              if(isset($_SESSION['feedback'][$form['id']]['vacunado'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['vacunado'],$feedback);
              }
          echo '
              ...
              if(isset($_SESSION['feedback'][$form['id']]['desparacitado'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['desparacitado'],$feedback);
              }
          echo '
              ...
              if(isset($_SESSION['feedback'][$form['id']]['alergias'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['alergias'],$feedback);
              }
          echo '
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              if(isset($_SESSION['feedback'][$form['id']]['adultos'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['adultos'],$feedback);
              }
          echo '
              ...
              if(isset($_SESSION['feedback'][$form['id']]['ninos'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['ninos'],$feedback);
              }
          echo '
              ...
              if(isset($_SESSION['feedback'][$form['id']]['gatos'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['gatos'],$feedback);
              }
          echo '
              ...
              if(isset($_SESSION['feedback'][$form['id']]['perros'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['perros'],$feedback);
              }
          echo '
           ...
           <div class="form-group">
            <label for="imagen" class="control-label">Requisitos para la adopcion:</label>
              ...
              if(isset($_SESSION['feedback'][$form['id']]['requisitos'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['requisitos'],$feedback);
              }
              echo '</textarea>
            </div>
             <div class="form-group">
            <label for="imagen" class="control-label">Puntos a conciderar:</label>
              ...
              if(isset($_SESSION['feedback'][$form['id']]['puntos'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['puntos'],$feedback);
              }
              echo '</textarea>
            </div>
             <div class="form-group">
            <label for="imagen" class="control-label">Proceso de adopcion:</label>
              ...
              if(isset($_SESSION['feedback'][$form['id']]['proceso'])){
                echo FeedbackValueOption($_SESSION['feedback'][$form['id']]['proceso'],$feedback);
              }
              echo '</textarea>
            </div>
          </fieldset>
      ...
      echo '<option value="'.$value['estado'].'">'.$value['estado'].'</option>';
           ...
           <div class="form-group">
            ...
            <div class="input-group">
              ...
              if(isset($_SESSION['feedback'][$form['id']]['titulo'])){
                echo FeedbackValue($_SESSION['feedback'][$form['id']]['titulo'],$feedback);
              }
              echo ' required="requiered">
            </div>
          </div>
           <div class="form-group">
              ...
              if(isset($_SESSION['feedback'][$form['id']]['descripcion'])){
                echo FeedbackValueData($_SESSION['feedback'][$form['id']]['descripcion'],$feedback);
              }
              echo '</textarea>
            </div>
            <div class="form-group">
