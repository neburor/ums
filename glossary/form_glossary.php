        ...
        <div class="media-left">
      	...
      	<div class="media-body">
            ...
            <form class="form" role="form" action="'.$form['action'].'#'.$form['callback'].'" method="POST">
              ...
              <div class="form-group '.$form['groupclass'].FeedbackClass($_SESSION['feedback'][$form['id']]['term'],$feedback).'">
          <div class="input-group">
            ...
            '.FeedbackIcon($_SESSION['feedback'][$form['id']]['term'],$feedback).'
              ...
              <div class="form-group '.$form['groupclass'].FeedbackClass($_SESSION['feedback'][$form['id']]['description'],$feedback).'">
              <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-edit"></i></span>
