...
else
     {
        ...
        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="caret"></span></button>
          <ul class="dropdown-menu dropdown-menu-right">
            <li class="hidden-xs"><a href="#" class="" data-ums="app.open.wrapper" data-show="app.user.login" data-toggle="show"><i class="fa fa-sign-in"></i> Iniciar sesión</a></li>
            <li class="visible-xs"><a href="#" class="" data-ums="app.open.offcanvas" data-show="app.user.login" data-toggle="show"><i class="fa fa-sign-in"></i> Iniciar sesión</a></li>
            ...
            <li role="separator" class="divider"></li>
            <li class="hidden-xs"><a href="#" data-ums="app.open.wrapper" data-show="app.user.login" data-toggle="show"><i class="fa fa-user-plus"></i> Registrarse</a></li>
            <li class="visible-xs"><a href="#" data-ums="app.open.offcanvas" data-show="app.user.login" data-toggle="show"><i class="fa fa-user-plus"></i> Registrarse</a></li>
          </ul>
      </div>';
        }