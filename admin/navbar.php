...
echo '<nav class="navbar navbar-inverse navbar-static-top">    
		<div class="container-fluid">      
			<div class="navbar-header">        
				...
				<button type="button" class="navbar-toggle collapsed domainname pull-right" data-offcanvas="offcanvas-right"><i class="fa fa-globe fa-2x"></i><span class="sr-only">'.$dataForm['domain'].'</span></button>
			</div>      
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#" class="dropdown-toggle img-link domainname" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><i class="fa fa-globe fa-2x"></i> '.$dataForm['domain'].'<span class="caret"></span></a>
