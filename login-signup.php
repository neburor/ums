    ...
    <div class="panel panel-default" id="panel_profile">
      <div class="panel-heading navheading">
        <ul class="nav nav-tabs nav-login">
          <li role="presentation" class="active"><a href="http://ums.hostingmex.com.mx/#login" data-target="#panel_profile-login" role="tab" data-toggle="tab" aria-controls="panel_profile-login" aria-expanded="true"> <i class="fa fa-sign-in"></i> Iniciar sesión</a></li>
          <li role="presentation" class=""><a href="http://ums.hostingmex.com.mx/?signup#signup" data-target="#panel_profile-signup" role="tab" data-toggle="tab" aria-controls="panel_profile-signup" aria-expanded="false"> <i class="fa fa-user-plus"></i> Registrarse</a></li>
        </ul>
      </div>
        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane fade active in" id="panel_profile-login">
            <div class="col-sm-5">
              ...
              <div class="form-group">
                ...
                <a class="btn btn-social-icon btn-facebook" href="http://ums.hostingmex.com.mx/account/login.php?login=facebook
                "> <i class="fa fa-facebook"></i></a> 
                <a class="btn btn-social-icon btn-twitter" href="http://ums.hostingmex.com.mx/account/login.php?login=twitter"> <i class="fa fa-twitter"></i></a>
              </div>
            </div>
            <form class="form col-sm-7 xxs-nopadding" role="form" action="http://ums.hostingmex.com.mx/account/login.php" method="POST">
          ...
          <div role="tabpanel" class="tab-pane fade" id="panel_profile-signup">
            <div class="col-sm-5">
              ...
              <div class="form-group">
                <a class="btn btn-block btn-social btn-facebook" href="http://ums.hostingmex.com.mx/login.php?login=facebook"> <i class="fa fa-facebook"></i> Registrarse con Facebook</a> 
                <a class="btn btn-block btn-social btn-twitter" href="http://ums.hostingmex.com.mx/login.php?login=twitter"> <i class="fa fa-twitter"></i> Registrarse con Twitter</a>
              </div>
            </div>
            <form class="form col-sm-7 xxs-nopadding" role="form" action="http://ums.hostingmex.com.mx/signup.php" method="POST">
